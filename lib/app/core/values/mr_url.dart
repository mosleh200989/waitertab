...
class MrUrl {
  ...
  static const String get_categories_list_url ='${MrConfig.base_app_url}resturant_salama/api/v1/system_settings/';
  static const String get_no_image_url ='${MrConfig.base_app_url}resturant_salama/assets/uploads/thumbs/no_image.png';
  static const String get_table_list_url ='${MrConfig.base_app_url}resturant_salama/api/v1/system_settings/restauranttables?api-key=${MrConfig.mr_api_key}';
  static const String get_product_list_url ='${MrConfig.base_app_url}resturant_salama/api/v1/';
}
